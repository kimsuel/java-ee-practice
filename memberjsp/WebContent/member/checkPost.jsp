...
<%
	...
	if(sido != null && roadname != null){
		list = memberjspDAO.getZipcodeList(sido, sigungu, roadname);
	}
%>
<html>
<head>
...
<% if(list != null){
	...
	<tr>
	<td width="50px" align="center"><%=zipcodeDTO.getZipcode()%></td>
	<td colspan="3"><a id="addressA" href="javascript:void(0)" onclick="checkPostClose('<%=zipcodeDTO.getZipcode()%>','<%= address %>')"><%= address %></a></td>
