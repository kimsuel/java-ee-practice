...
<form name="boardWriteForm" method="post" action="boardWrite.do">
	<table>
		<tr height="40">
			...
			<td><input type="text" name="subject" style="width:315px; background-color:transparent;"></td>
		</tr>
		<tr height="200">
		...
		<tr>
			...
			<input type="button" class="btn btn-primary outline" value="글쓰기" onclick="checkBoardWrite()">
